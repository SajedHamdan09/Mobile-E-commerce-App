...
Future<List<dynamic>> fetchData() async {
  ...
  final response = await http.get(Uri.parse('https://fakestoreapi.in/api/products/category?type=laptop&sort=desc'));
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ProductDetailsCartPage(
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: <Widget>[
                            Positioned(top: 0,right: -7, child: IconButton(
                              onPressed: () async {
                                await db.insertData(
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                ElevatedButton(
                                  ...
                                  child: Icon(Icons.shopping_cart, color: Color(0xFFFF274C77)),
                                ),
                              ],
                            ),
                            // Positioned(
